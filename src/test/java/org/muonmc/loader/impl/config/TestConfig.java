...
import org.muonmc.loader.api.config.v2.MuonConfig;
...
public class TestConfig {
	...
	public void testSerializer() {
		Config config = MuonConfig.create("testmod", "testConfig6", builder -> {
	...
	public void testValidation() {
		Assertions.assertThrows(TrackedValueException.class, () -> {
			MuonConfig.create("testmod", "testConfig1", builder -> {
				builder.field(TrackedValue.create(new ArrayList<Integer>(), "boop"));
			});
		});

		Assertions.assertThrows(TrackedValueException.class, () -> {
			MuonConfig.create("testmod", "testConfig2", builder -> {
	...
	public void testValues() {
		Config config = MuonConfig.create("testmod", "testConfig3", builder -> {
	...
	public void testMetadata() {
		Config config = MuonConfig.create("testmod", "testConfig4", builder -> {
	...
	public void testFlags() {
		Config config = MuonConfig.create("testmod", "testConfig5", builder -> {
			builder.field(TEST_INTEGER = TrackedValue.create(0, "testInteger"));
			builder.field(TEST_BOOLEAN = TrackedValue.create(false, "testBoolean"));
			builder.field(TEST_STRING  = TrackedValue.create("blah", "testString"));
		});
	...
	public void testConstraints() {
		Assertions.assertThrows(TrackedValueException.class, () -> MuonConfig.create("testmod", "testConfig6", builder -> {
			builder.field(TEST_INTEGER = TrackedValue.create(0, "testInteger", creator -> {
				// Should throw an exception since the default value is outside the constraint range
		...
		Assertions.assertThrows(TrackedValueException.class, () -> {
			MuonConfig.create("testmod", "testConfig7", builder -> {
				builder.field(TEST_INTEGER = TrackedValue.create(0, "testInteger", creator -> {
		...
		Assertions.assertThrows(TrackedValueException.class, () -> {
			MuonConfig.create("testmod", "testConfig8", builder -> {
				builder.field(TEST_INTEGER = TrackedValue.create(0, "testInteger", creator -> {
					creator.constraint(Constraint.range(-10, 10));
				}));
				builder.field(TEST_BOOLEAN = TrackedValue.create(false, "testBoolean"));
		...
		MuonConfig.create("testmod", "testConfig9", builder -> {
			builder.field(TEST_INTEGER = TrackedValue.create(0, "testInteger", creator -> {
				creator.constraint(Constraint.range(-10, 10));
			}));
			builder.field(TEST_BOOLEAN = TrackedValue.create(false, "testBoolean"));
	...
	public void testReflectiveConfigs(String id, String format) {
		TestReflectiveConfig config = MuonConfig.create("testmod", id, TestReflectiveConfig.class, builder -> {
		...
		Assertions.assertThrows(ConfigFieldException.class, () -> {
			MuonConfig.create("testmod", "testConfig", TestReflectiveConfig2.class);
		}).printStackTrace();

		Assertions.assertThrows(ConfigFieldException.class, () -> {
			MuonConfig.create("testmod", "testConfig", TestReflectiveConfig3.class);
		}).printStackTrace();

		Assertions.assertThrows(TrackedValueException.class, () -> {
			MuonConfig.create("testmod", "testConfig", TestReflectiveConfig4.class);
		}).printStackTrace();
	}
...
//		TestReflectiveConfig config = MuonConfig.create("testmod", "testConfig12", TestReflectiveConfig.class, builder -> {
//			builder.format("toml");
//		});
//
//		for (TrackedValue<?> value : config.values()) {
...
//		}
	...
	public void testValueMapBehavior() {
		// FIXME: doesn't work
//		TestValueMapConfig c = MuonConfig.create("testmod", "testConfig13", TestValueMapConfig.class);
//
//		c.weights.put("" + c.weights.size(), c.weights.size());
	...
	public void testValueListBehavior() {
		// FIXME: does not work
//		TestValueListConfig c = MuonConfig.create("testmod", "testConfig14", TestValueListConfig.class);
//
