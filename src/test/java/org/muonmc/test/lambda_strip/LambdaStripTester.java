...
package org.muonmc.test.lambda_strip;
...
public class LambdaStripTester {
	...
	public static void main(String[] args) throws IOException {
		String[] files = { //
			"bin/test/org/muonmc/test/lambda_strip/on/ClassWithLambda.class", //
			"bin/test/org/muonmc/test/lambda_strip/on/ClassWithCaptureLambda.class", //
			"bin/test/org/muonmc/test/lambda_strip/on/ClassWithMethodReference.class"//
		};
		...
		for (String path : files) {
			...
			ClassStrippingData strip = new ClassStrippingData(Opcodes.ASM9, Environment.DEDICATED_SERVER, new ArrayList<>());
