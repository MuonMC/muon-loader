...
package org.muonmc.loader.api;

import org.jetbrains.annotations.ApiStatus;
import org.jetbrains.annotations.Nullable;
import org.muonmc.loader.impl.metadata.qmj.ModLicenseImpl;
...
public interface ModLicense {
	...
	/** Looks up a {@link ModLicense} from the given SPDX license ID, returning null if muon-loader is unaware of
	 * it. */
	@Nullable
	 ...
	 * {@link #name()} and {@link #id()} set to the passed identifier, the other fields blank) if muon-loader is
	 * unaware of it. */
