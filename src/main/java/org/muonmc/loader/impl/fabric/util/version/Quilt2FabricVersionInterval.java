...
public final class Quilt2FabricVersionInterval implements VersionInterval {
	...
	public Quilt2FabricVersionInterval(Version min, boolean minInclusive,
		...
		this.quilt = org.muonmc.loader.api.VersionInterval.of(Quilt2FabricVersion.fromFabric(min), minInclusive,
			Quilt2FabricVersion.fromFabric(max), maxInclusive);
	}

	public Quilt2FabricVersionInterval(org.muonmc.loader.api.VersionInterval quilt) {
	...
	public static VersionInterval and(VersionInterval a, VersionInterval b) {
		...
		org.muonmc.loader.api.VersionInterval and = VersionIntervalImpl.and(((Quilt2FabricVersionInterval) a).quilt, ((Quilt2FabricVersionInterval) b).quilt);
		if (and == null) {
			return null;
		}
	...
	public static List<VersionInterval> and(Collection<VersionInterval> a, Collection<VersionInterval> b) {
		...
		for (org.muonmc.loader.api.VersionInterval quilt : combined) {
	...
	private static VersionRange toRange(Collection<VersionInterval> a) {
		List<org.muonmc.loader.api.VersionInterval> quilt = new ArrayList<>();
