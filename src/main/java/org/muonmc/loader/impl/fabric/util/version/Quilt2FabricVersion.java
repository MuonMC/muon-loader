...
public class Quilt2FabricVersion implements net.fabricmc.loader.api.Version {
	...
	Quilt2FabricVersion(Version quilt) {
		this.quilt = quilt;
	}

	public static net.fabricmc.loader.api.Version toFabric(Version quilt) {
		if (quilt == null) {
			return null;
	...
	public static Version fromFabric(net.fabricmc.loader.api.Version from) {
		if (from == null) {
			return null;
