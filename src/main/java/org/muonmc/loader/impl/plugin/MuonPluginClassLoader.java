...
import org.muonmc.loader.impl.transformer.InternalsHiderTransform;
...
final class MuonPluginClassLoader extends ClassLoader {
	final MuonPluginContextImpl context;
	final Path from;
	final Set<String> loadablePackages;

	public MuonPluginClassLoader(
			MuonPluginContextImpl context, ClassLoader parent, Path from,
