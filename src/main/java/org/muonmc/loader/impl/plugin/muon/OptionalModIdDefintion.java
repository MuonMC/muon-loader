...
public final class OptionalModIdDefintion extends ModIdDefinition {
	...
	public OptionalModIdDefintion(MuonPluginManager manager, RuleContext ctx, String modid) {
	...
	public void appendRuleDescription(Consumer<MuonLoaderText> to) {
		to.accept(MuonLoaderText.translate("solver.rule.mod_def.optional", modid, sources.size()));
		for (ModLoadOption mod : sources) {
			to.accept(MuonLoaderText.translate("solver.rule.mod_def.optional.source", mod.describe()));
		}
	}
}
