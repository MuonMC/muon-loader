...
public abstract class MuonBasePath<FS extends MuonBaseFileSystem<FS, P>, P extends MuonBasePath<FS, P>>
	implements Path {
	...
	private static final boolean VALIDATE = SystemProperties.getBoolean(
		SystemProperties.VALIDATE_MUON_BASE_PATH, SystemProperties.VALIDATION_LEVEL > 0
	);
	...
	MuonBasePath(FS fs, @Nullable P parent, String name) {
	...
	public boolean equals(Object obj) {
		...
		MuonBasePath<?, ?> o = (MuonBasePath<?, ?>) obj;
	...
	public boolean isToStringEqual(Path other) {
		if (!(other instanceof MuonBasePath)) {
	...
	private boolean quickIsToStringEqual(Path other) {
		MuonBasePath<?, ?> o = (MuonBasePath<?, ?>) other;
	 ...
	 * {@link Handler} and
	 * {@link org.muonmc.loader.impl.filesystem.quilt.jfs.Handler} */
