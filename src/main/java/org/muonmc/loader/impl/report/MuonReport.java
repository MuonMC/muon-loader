...
public class MuonReport {

	private final String header;
	private final List<String> overview = new ArrayList<>();
	private final List<MuonReportSection> sections = new ArrayList<>();

	public MuonReport(String header) {
		this.header = header;
	}
	...
	public <S extends MuonReportSection> S addSection(S section) {
		sections.add(section);
		return section;
	}

	public MuonStringSection addStringSection(String name, int ordering, String... lines) {
		return addSection(new MuonStringSection(name, ordering, lines));
	}

	public MuonStacktraceSection addStacktraceSection(String name, int ordering, Throwable ex) {
		return addSection(new MuonStacktraceSection(ordering, name, ex));
	}

	public List<MuonReportSection> getSections() {
		sections.sort(null);
	...
	private void writeInternal(PrintWriter to, boolean toLog) {
		...
		for (MuonReportSection section : sections) {
